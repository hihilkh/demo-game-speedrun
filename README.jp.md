...
ソースコードのご案内は[こちら](./doc/SourceCodeGuide.jp.md)へ。

自作ゲームライブラリの詳細は[こちら](./doc/GameLibraryDetails.jp.md)へ。
...
* ソースコードのご案内：[こちら](./doc/SourceCodeGuide.jp.md)
* 自作ゲームライブラリ：[こちら](./doc/GameLibraryDetails.jp.md)
...
* ゲームライブラリを作る時、メモリ管理、コードの効率、テンプレート、リンカとコンパイラのことなどを色々な知識を勉強しました。また、C++のよく使う技術とシンタックスとベストプラクティスも勉強しました。以前よりC++に馴染んでくると思います。([使った技術](./doc/GameLibraryDetails.jp.md#%E4%BD%BF%E3%81%A3%E3%81%9F%E6%8A%80%E8%A1%93))
* このプロジェクトでいくつかのデザインパターンを実際に使っていて、これらのパターンの原理と使い方がもっと理解できました。([使った技術](./doc/GameLibraryDetails.jp.md#%E4%BD%BF%E3%81%A3%E3%81%9F%E6%8A%80%E8%A1%93))
